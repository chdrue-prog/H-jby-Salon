...
import { Phone, CheckCircle, Info, Sparkles, Scissors, Clock } from 'lucide-react';
    ...
    <div>
      ...
      <section style={{ backgroundColor: 'var(--bg-dark)', color: '#FFFFFF', padding: '5rem 0 4rem', textAlign: 'center' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '1.2rem', color: '#D6D3D1', maxWidth: '650px', margin: '0 auto' }}>
            Transparente priser uden skjulte gebyrer. Både med og uden tidsbestilling.
          </p>
        </div>
      </section>
      ...
      <section style={{ backgroundColor: 'var(--bg-card)', padding: '2rem 0', borderBottom: '1px solid var(--accent-border)' }}>
        <div className="container">
          <div style={{ display: 'flex', alignItems: 'center', gap: '1.5rem', flexWrap: 'wrap' }}>
            <div style={{ width: '54px', height: '54px', borderRadius: '50%', background: 'var(--accent-gold)', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyCenter: 'center', flexShrink: 0 }}>
              <Info size={28} style={{ margin: 'auto' }} />
            </div>
            <div style={{ flex: 1 }}>
            ...
            <div key={idx} style={{ marginBottom: '4rem' }}>
              ...
              <div className="grid-2" style={{ gap: '1.5rem' }}>
                {cat.items.map((item, itemIdx) => (
                  <div key={itemIdx} className="price-card">
                    <div>
                    ...
                    <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginTop: '1.5rem', paddingTop: '1rem', borderTop: '1px solid var(--accent-border)' }}>
                      <span style={{ fontSize: '0.85rem', color: 'var(--text-muted)' }}>
                        Drop-in eller tidsbestilling
                      </span>
                      <a href="tel:+4520188903" className="btn btn-outline-gold btn-sm">
                        <Phone size={14} />
        ...
        <div className="container">
          ...
          <div className="grid-3">
            <div className="glass-card">
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
                Du kan altid chancen og komme forbi salonen direkte (drop-in). Hvis der er optaget, kan du vente i vores behagelige ventelounge eller ringe i forvejen for at sikre din tid.
              </p>
            </div>
            ...
            <div className="glass-card">
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
                Vi modtager både MobilePay, kontanter samt de mest gængse betalingskort (Visa, Mastercard, Dankort).
              </p>
            </div>
            ...
            <div className="glass-card">
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '0.95rem' }}>
                Der er gratis og nem parkering lige ved døren foran salonen i Højby.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="section section-dark text-center">
        <div className="container">
          ...
          <p style={{ color: '#D6D3D1', fontSize: '1.1rem', marginBottom: '2rem' }}>Telefonen er åben i hele vores åbningstid.</p>
