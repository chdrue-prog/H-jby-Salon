      ...
      <section style={{ backgroundColor: 'var(--bg-dark)', color: '#FFFFFF', padding: '5rem 0 4rem', textAlign: 'center' }}>
        <div className="container">
          ...
          <p style={{ fontSize: '1.2rem', color: '#D6D3D1', maxWidth: '650px', margin: '0 auto' }}>
            Traditionsrigt håndværk, personlig service og herreklip i et afslappet og venligt miljø.
          </p>
        </div>
      </section>
          ...
          <div className="grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', marginBottom: '1.25rem', lineHeight: 1.7 }}>
                Højby Salon er grundlagt med et simpelt formål: at tilbyde et sted i Højby, hvor du kan træde ind ad døren, slappe af og få en klipning eller skægtrimning i topklasse til yderst rimelige priser (Herreklip 200,- | Børneklip 150,- | Pensionistklip 150,-).
              </p>
              ...
              <div className="dark-card" style={{ marginTop: '2rem' }}>
                <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', marginBottom: '0.75rem' }}>
                  <Award size={24} style={{ color: 'var(--accent-gold)' }} />
                  <h4 style={{ fontSize: '1.25rem', color: '#FFFFFF' }}>Kvalitetsgaranti</h4>
                </div>
                <p style={{ fontSize: '0.95rem', color: '#D6D3D1' }}>
        ...
        <div className="container">
          <div className="grid-2" style={{ alignItems: 'center', gap: '4rem' }}>
            ...
            <div>
              ...
              <p style={{ color: 'var(--text-muted)', fontSize: '1.05rem', marginBottom: '1.25rem', lineHeight: 1.7 }}>
                Salonen er placeret i en klassisk gulstensejendom med tydelig skiltning, barberstænger og gode gratis parkeringsmuligheder lige foran døren.
              </p>
              <div style={{ padding: '1rem', background: '#FFFFFF', borderRadius: 'var(--radius-md)', border: '1px solid var(--accent-border)' }}>
                <div style={{ fontWeight: 700, fontSize: '1.1rem', color: 'var(--accent-gold)', marginBottom: '0.25rem' }}>
                  Med & Uden Tidsbestilling
                </div>
                <div style={{ fontSize: '0.95rem', color: 'var(--text-muted)' }}>
                  Man: Lukket | Tir-Fre: 10:00-17:30 | Lør-Søn: 10:00-15:00<br />
      ...
      <section className="section text-center">
        <div className="container">
          <div className="glass-card" style={{ padding: '3.5rem 2rem', background: 'var(--bg-dark)', color: '#FFFFFF' }}>
            ...
            <p style={{ color: '#D6D3D1', fontSize: '1.1rem', marginBottom: '2rem', maxWidth: '600px', margin: '0 auto 2rem' }}>
